                  ...
                  <table class="table table-striped table-sm">
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <span>{{currentUser.currency}} {{quote.TaxNet.toLocaleString('en',{minimumFractionDigits:2, maximumFractionDigits:2})}} ({{formatNumber(quote.tax_rate ,2)}} %)</span>
                        </td>
                      </tr>
                      <tr>
                        <td class="bold">{{$t('Discount')}}</td>
                        <td>{{currentUser.currency}} {{quote.discount.toLocaleString('en',{minimumFractionDigits:2, maximumFractionDigits:2})}}</td>
                      </tr>
                      <tr>
                        <td class="bold">{{$t('Shipping')}}</td>
                        <td>{{currentUser.currency}} {{quote.shipping.toLocaleString('en',{minimumFractionDigits:2, maximumFractionDigits:2})}}</td>
                      </tr>
                      <tr>
                        <td>
   ...
   // Search Products
    ...
    Get_Products_By_Warehouse(id) {
      // Start the progress bar.
        ...
        NProgress.set(0.1);
      axios
        .get("get_Products_by_warehouse/" + id + "?stock=" + 1 + "&product_service=" + 1)
         .then(response => {
