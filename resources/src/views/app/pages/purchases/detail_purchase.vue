                ...
                <table class="table table-hover table-md">
                  ...
                  <tbody>
                    <tr v-for="detail in details">
                      ...
                      <td>{{currentUser.currency}} {{detail.total.toLocaleString('en',{minimumFractionDigits:2, maximumFractionDigits:2})}}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <table class="table table-striped table-sm">
                <tbody>
                  <tr>
                    ...
                    <td>
                      <span>{{currentUser.currency}} {{purchase.TaxNet.toLocaleString('en',{minimumFractionDigits:2, maximumFractionDigits:2})}} ({{formatNumber(purchase.tax_rate,2)}} %)</span>
                    </td>
                  </tr>
                  <tr>
                    <td class="bold">{{$t('Discount')}}</td>
                    <td>{{currentUser.currency}} {{purchase.discount.toLocaleString('en',{minimumFractionDigits:2, maximumFractionDigits:2})}}</td>
                  </tr>
                  <tr>
                    <td class="bold">{{$t('Shipping')}}</td>
                    <td>{{currentUser.currency}} {{purchase.shipping.toLocaleString('en',{minimumFractionDigits:2, maximumFractionDigits:2})}}</td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      ...
                      >{{currentUser.currency}} {{purchase.GrandTotal.toLocaleString('en',{minimumFractionDigits:2, maximumFractionDigits:2})}}</span>
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      <span
                        class="font-weight-bold"
                      >{{currentUser.currency}} {{purchase.paid_amount.toLocaleString('en',{minimumFractionDigits:2, maximumFractionDigits:2})}}</span>
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      <span
                        class="font-weight-bold"
                      >{{currentUser.currency}} {{purchase.due.toLocaleString('en',{minimumFractionDigits:2, maximumFractionDigits:2})}}</span>
                    </td>
                  </tr>
                </tbody>
              </table>
