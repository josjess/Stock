        ...
        <b-form @submit.prevent="Submit_Payment">
          <b-row>
            ...
            <b-col lg="4" md="12" sm="12">
              ...
              <p
                class="change_amount"
              >{{parseFloat(facture.received_amount - facture.montant).toLocaleString('en',{minimumFractionDigits:2, maximumFractionDigits:2})}}</p>
            </b-col>
...
export default {
  ...
  methods: {
    ...
    Edit_Payment(facture) {
      ...
      this.facture.received_amount = parseFloat(facture.montant + facture.change).toLocaleString('en',{minimumFractionDigits:2, maximumFractionDigits:2});
      ...
      NProgress.set(0.1);
        axios
          .post("payment_purchase", {
            ...
            montant: parseFloat(this.facture.montant).toLocaleString('en',{minimumFractionDigits:2, maximumFractionDigits:2}),
            received_amount: parseFloat(this.facture.received_amount).toLocaleString('en',{minimumFractionDigits:2, maximumFractionDigits:2}),
            Reglement: this.facture.Reglement,
            account_id: this.facture.account_id,
            change: parseFloat(this.facture.received_amount - this.facture.montant).toLocaleString('en',{minimumFractionDigits:2, maximumFractionDigits:2}),
