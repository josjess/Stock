            ...
            <b-card>
              <b-row>
               ...
               <b-col lg="4" md="4" sm="12" class="mb-3">
                  ...
                  <table class="table table-striped table-sm">
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <span>{{currentUser.currency}} {{sale_return.TaxNet.toLocaleString('en',{minimumFractionDigits:2, maximumFractionDigits:2})}} ({{formatNumber(sale_return.tax_rate ,2)}} %)</span>
                        </td>
                      </tr>
                      <tr>
                        <td class="bold">{{$t('Discount')}}</td>
                        <td>{{currentUser.currency}} {{sale_return.discount.toLocaleString('en',{minimumFractionDigits:2, maximumFractionDigits:2})}}</td>
                      </tr>
                      <tr>
                        <td class="bold">{{$t('Shipping')}}</td>
                        <td>{{currentUser.currency}} {{sale_return.shipping.toLocaleString('en',{minimumFractionDigits:2, maximumFractionDigits:2})}}</td>
                      </tr>
                      <tr>
                        <td>
                ...
                <b-col md="12">
                  <b-form-group>
                    <b-button variant="primary" @click="Submit_Sale_return" :disabled="SubmitProcessing"><i class="i-Yes me-2 font-weight-bold"></i> {{$t('submit')}}</b-button>
