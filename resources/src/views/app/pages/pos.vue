                            ...
                            <tbody>
                              ...
                              <tr v-for="(detail, index) in details" :key="index">
                                ...
                                <td>
                                 ...
                                 <td class="text-center">{{currentUser.currency}} {{detail.subtotal.toLocaleString('en',{minimumFractionDigits:2, maximumFractionDigits:2})}}</td>
                                <td>
                                  <a
                    ...
                    <b-row>
                      <b-col md="12">
                        <div class="grandtotal">
                          <span>{{$t("Total_Payable")}} : {{currentUser.currency}} {{GrandTotal.toLocaleString('en',{minimumFractionDigits:2, maximumFractionDigits:2})}}</span>
                        </div>
                      </b-col>
                ...
                <tbody>
                  ...
                  <tr v-show="invoice_pos.sale.paid_amount < invoice_pos.sale.GrandTotal">
                    ...
                    <td
                      style="text-align:right;"
                      class="total"
                    >{{invoice_pos.symbol}} {{parseFloat(invoice_pos.sale.GrandTotal - invoice_pos.sale.paid_amount).toLocaleString('en',{minimumFractionDigits:2, maximumFractionDigits:2})}}</td>
                  </tr>
                </tbody>
              </table>
                ...
                <b-col md="6">
                  <b-row>
                    ...
                    <b-col lg="12" md="12" sm="12">
                      ...
                      <p
                        class="change_amount"
                      >{{parseFloat(payment.received_amount - payment.amount).toLocaleString('en',{minimumFractionDigits:2, maximumFractionDigits:2})}}</p>
                    </b-col>
                    ...
                    <b-card>
                      <b-list-group>
                        ...
                        <b-list-group-item class="d-flex justify-content-between align-items-center">
                          ...
                          >{{currentUser.currency}} {{sale.TaxNet.toLocaleString('en',{minimumFractionDigits:2, maximumFractionDigits:2})}} ({{sale.tax_rate}} %)</span>
                        </b-list-group-item>
                        <b-list-group-item class="d-flex justify-content-between align-items-center">
                          {{$t('Discount')}}
                          <span
                            class="font-weight-bold"
                          >{{currentUser.currency}} {{sale.discount.toLocaleString('en',{minimumFractionDigits:2, maximumFractionDigits:2})}}</span>
                        </b-list-group-item>
                        ...
                        <b-list-group-item class="d-flex justify-content-between align-items-center">
                          ...
                          <span
                            class="font-weight-bold"
                          >{{currentUser.currency}} {{sale.shipping.toLocaleString('en',{minimumFractionDigits:2, maximumFractionDigits:2})}}</span>
                        </b-list-group-item>
                        ...
                        <b-list-group-item class="d-flex justify-content-between align-items-center">
                          ...
                          <span
                            class="font-weight-bold"
                          >{{currentUser.currency}} {{GrandTotal.toLocaleString('en',{minimumFractionDigits:2, maximumFractionDigits:2})}}</span>
                        </b-list-group-item>
                      </b-list-group>
                    </b-card>
                </b-col>
...
export default {
  ...
  methods: {
      ...
      if (error) {
        ...
        axios
          .post("pos/create_pos", {
            ...
            amount : parseFloat(this.payment.amount).toLocaleString('en',{minimumFractionDigits:2, maximumFractionDigits:2}),
            received_amount : parseFloat(this.payment.received_amount).toLocaleString('en',{minimumFractionDigits:2, maximumFractionDigits:2}),
            change: parseFloat(this.payment.received_amount - this.payment.amount).toLocaleString('en',{minimumFractionDigits:2, maximumFractionDigits:2}),
            token: token.id,
    ...
    CaclulTotal() {
      ...
      var grand_total =  this.GrandTotal.toLocaleString('en',{minimumFractionDigits:2, maximumFractionDigits:2});
