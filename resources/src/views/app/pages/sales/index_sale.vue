        ...
        <b-form @submit.prevent="Submit_Payment">
          ...
          <b-row>
            ...
            <b-col lg="4" md="12" sm="12">
              ...
              <p
                class="change_amount"
              >{{parseFloat(payment.received_amount - payment.montant).toLocaleString('en',{minimumFractionDigits:2, maximumFractionDigits:2})}}</p>
            </b-col>
...
export default {
  ...
  methods: {
    ...
    Edit_Payment(payment) {
      ...
      this.payment.received_amount = parseFloat(payment.montant + payment.change).toLocaleString('en',{minimumFractionDigits:2, maximumFractionDigits:2});
      ...
      if (error) {
        ...
        axios
          .post("payment_sale", {
            ...
            montant: parseFloat(this.payment.montant).toLocaleString('en',{minimumFractionDigits:2, maximumFractionDigits:2}),
            ...
            change: parseFloat(this.payment.received_amount - this.payment.montant).toLocaleString('en',{minimumFractionDigits:2, maximumFractionDigits:2}),
