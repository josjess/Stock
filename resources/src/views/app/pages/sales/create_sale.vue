                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                        ...
                        <tr v-for="detail  in details" >
                          ...
                          <td>{{currentUser.currency}} {{detail.subtotal.toLocaleString('en',{minimumFractionDigits:2, maximumFractionDigits:2})}}</td>
                          <td>
                  ...
                  <table class="table table-striped table-sm">
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <span>{{currentUser.currency}} {{sale.TaxNet.toLocaleString('en',{minimumFractionDigits:2, maximumFractionDigits:2})}} ({{formatNumber(sale.tax_rate,2)}} %)</span>
                        </td>
                      </tr>
                      <tr>
                        <td class="bold">{{$t('Discount')}}</td>
                        <td>{{currentUser.currency}} {{sale.discount.toLocaleString('en',{minimumFractionDigits:2, maximumFractionDigits:2})}}</td>
                      </tr>
                      <tr>
                        <td class="bold">{{$t('Shipping')}}</td>
                        <td>{{currentUser.currency}} {{sale.shipping.toLocaleString('en',{minimumFractionDigits:2, maximumFractionDigits:2})}}</td>
                      </tr>
                      <tr>
                        <td>
...
export default {
  ...
  methods: {
    ...
    Selected_PaymentStatus(value){
      if (value == "paid") {
        var payment_amount = this.GrandTotal.toLocaleString('en',{minimumFractionDigits:2, maximumFractionDigits:2});
