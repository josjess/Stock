                  ...
                  <table class="table table-striped table-sm">
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <span>{{currentUser.currency}} {{transfer.TaxNet.toLocaleString('en',{minimumFractionDigits:2, maximumFractionDigits:2})}} ({{formatNumber(transfer.tax_rate ,2)}} %)</span>
                        </td>
                      </tr>
                      <tr>
                        <td class="bold">{{$t('Discount')}}</td>
                        <td>{{currentUser.currency}} {{transfer.discount.toLocaleString('en',{minimumFractionDigits:2, maximumFractionDigits:2})}}</td>
                      </tr>
                      <tr>
                        <td class="bold">{{$t('Shipping')}}</td>
                        <td>{{currentUser.currency}} {{transfer.shipping.toLocaleString('en',{minimumFractionDigits:2, maximumFractionDigits:2})}}</td>
                      </tr>
                      <tr>
                        <td>
