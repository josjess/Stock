              ...
              <table class="table table-striped table-sm">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <span>{{currentUser.currency}} {{purchase_return.discount.toLocaleString('en',{minimumFractionDigits:2, maximumFractionDigits:2})}}</span>
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      <span>{{currentUser.currency}} {{purchase_return.shipping.toLocaleString('en',{minimumFractionDigits:2, maximumFractionDigits:2})}}</span>
                    </td>
                  </tr>
                  <tr>
                    <td>
